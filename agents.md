# AI Agent Guidelines for Config Report
...
- The app obscures passwords and secrets - ensure this behavior is maintained
...
- Secret obscuration logic is critical - never expose passwords or secrets in config reports
